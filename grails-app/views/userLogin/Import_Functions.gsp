...
<head>
    ...
    <title>Import CSV File Functions</title>
...
<h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Import CSV File Functions :  user ${session?.userId}</h1>

<h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Quick Kanban v1.0 by N.Michael</h2>


<div id="status" role="complementary">
    <h1>Import CSV File Functions</h1>
    ...
    <div id="controller-list" role="navigation">
        ...
        <ul>
            <tag:isAuthenticated userId="${session.userId}">
                <li class="controller"><h2>Import CSV File Functions</h2></li>
                <li class="controller"><g:link controller="setup"
                                               action="uploadUserStoryCsv">1)&nbsp;&nbsp;Import User Story  CSV File</g:link></li>
                <li class="controller"><g:link controller="userStorySubtask"
                                               action="uploadSubtasksCsv">2)&nbsp;&nbsp;Import User Story Subtask CSV File</g:link></li>
            </tag:isAuthenticated>
