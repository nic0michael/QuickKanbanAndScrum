...
<h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Administrator Functions :  user ${session?.userId}</h1>
...
<div id="page-body" role="main">
    <div id="controller-list" role="navigation">
        ...
        <ul>
            %{--<tag:isInitialized>--}%
                <tag:isAdmin userId="${session.userId}">
                    %{--<tag:showControllers showControllers="${session.showControllers}">--}%
                        <h2>Administrator Functions (Controllers):</h2>
                        <li class="controller"><g:link controller="userLogin" action="Management_Functions"><b>Show Management Functions</b></g:link></li>
