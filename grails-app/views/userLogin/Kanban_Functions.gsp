...
<h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Kanban Functions :  user ${session?.userId}</h1>
<h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Quick Kanban v1.0 by N.Michael</h2>


<div id="status" role="complementary">
    <h1>Kanban Functions</h1>
...
<div id="page-body" role="main">
    <div id="controller-list" role="navigation">
        ...
        <ul>
            <tag:isInitialized>
                <tag:isAdmin userId="${session.userId}">
                    <li class="controller"><h2>Kanban Functions</h2></li>
                    <li class="controller"><g:link controller="userStory">1)&nbsp;Add a User Story</g:link></li>
                    <li class="controller"><g:link
                            controller="userStorySubtask">2)&nbsp;&nbsp;Add all SubTasks</g:link></li>
                    <li class="controller"><a href="kanbanBoardHighLevel">1)&nbsp;High Level Kanban Board</a></li>
                    <li class="controller"><a href="kanbanBoardLowLevel">2)&nbsp;Low Level Kanban Board</a></li>
                    <li class="controller"><a href="highLevelReport">3)&nbsp;High Level Printable Report</a></li>
                    <li class="controller"><a href="lowLevelReport">4)&nbsp;Low Level Printable Report</a></li>
                    <li class="controller"><a href="archived">5)&nbsp;Archived UserStories</a></li>
                    <li class="controller"><a href="rejected">6)&nbsp;Rejected UserStories</a></li>
                </tag:isAdmin>
